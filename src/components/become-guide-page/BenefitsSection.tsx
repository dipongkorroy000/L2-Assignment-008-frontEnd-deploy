...
export default function BenefitsSection() {
  return (
    <section className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 py-16">
      {benefits.map((item, i) => (
        <motion.div
          key={item.title}
          ...
          className="bg-white rounded-lg shadow-md py-14 px-6 text-center hover:scale-105 transform transition"
        >
