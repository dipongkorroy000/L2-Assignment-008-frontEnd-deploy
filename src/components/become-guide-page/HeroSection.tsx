...
export default function HeroSection() {
  return (
    <section className="text-center py-16 max-md:py-10">
      ...
      <p className="mt-4 text-gray-600 dark:text-muted-foreground max-w-2xl mx-auto max-md:text-sm max-md:px-10">Share your city’s stories, earn money, and connect with travelers from around the world.</p>
