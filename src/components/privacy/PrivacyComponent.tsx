...
const PrivacyComponent = () => {
  return (
    <>
      <h1 className="text-4xl text-center mb-10 font-semibold  max-xl:text-2xl max-lg:text-xl text-primary max-md:mb-5">Privacy & Data Protection</h1>

      {/* Privacy Overview Card */}
      <div className="shadow-sm mb-10 p-8 space-y-5 border-none max-md:mb-5 max-md:space-y-2 max-md:p-5">
      ...
      <Accordion type="single" collapsible className="w-full p-10 max-md:p-5">
        <AccordionItem value="dataCollection">
          <AccordionTrigger className="text-xl max-md:text-[16px]">Data We Collect</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
            <ul className="list-disc pl-6 space-y-1 text-lg max-md:text-sm">
        ...
        <AccordionItem value="dataUsage">
          <AccordionTrigger className="text-xl max-md:text-[16px]">How We Use Your Data</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
            <ul className="list-disc pl-6 space-y-1 text-lg max-md:text-sm">
        ...
        <AccordionItem value="rights">
          <AccordionTrigger className="text-xl max-md:text-[16px]">Your Rights</AccordionTrigger>
          <AccordionContent className="text-muted-foreground">
            <ul className="list-disc pl-6 space-y-1 text-lg max-md:text-sm">
