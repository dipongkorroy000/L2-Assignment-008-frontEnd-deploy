...
const FilterGuides = ({languages, categories}: {languages: string[]; categories: {id: number; title: string}[]}) => {
  ...
  return (
    <section className="w-full bg-white rounded-lg shadow-sm p-4 space-y-4 md:space-y-0 md:flex md:flex-row md:items-center md:gap-4">
      {/* Search Box */}
      ...
      <div className="flex flex-col gap-2 md:flex-row md:gap-2 w-full md:w-auto">
        ...
        <Button variant="outline" onClick={clearFilters} disabled={isPending} className="w-full md:w-auto">
          Clear
        </Button>
      </div>
    </section>
