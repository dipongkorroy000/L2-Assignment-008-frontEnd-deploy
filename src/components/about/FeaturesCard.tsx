...
export default function FeaturesCard() {
  return (
    <motion.div
      ...
      className="p-6 rounded-lg shadow-sm bg-white dark:bg-gray-900 hover:shadow-md transition text-start"
    >
      <h3 className="text-xl font-semibold text-primary mb-3 max-md:text-lg">⚡ Features</h3>
      <ul className="list-disc list-inside text-gray-600 dark:text-muted-foreground space-y-2 text-start max-md:text-sm">
