      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8 max-md:gap-5">
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-4">
            <Link href="https://www.facebook.com/profile.php?id=61570830432784" target='_blank' className="hover:text-white">🌐 Facebook</Link>
            <Link href="https://x.com/dipongkorroy000" target='_blank' className="hover:text-white">🐦 Twitter</Link>
          </div>
        </div>
      </div>
